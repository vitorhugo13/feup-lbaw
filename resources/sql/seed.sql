...
insert into "user" (id, username, email, password, bio, role, release_date) values (101, 'vitinho', 'vitinho@mail.pt', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'Olá, eu sou o Vitinho.', 'Blocked', '2021-02-26 12:00:31');

select setval('user_id_seq', 101);


-- insert content (400 in which 20 have anonymous authors)
insert into content (id, visible, author, body, creation_time) values (1, false, null, 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo. Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros.', '2020-02-08 23:58:01');
