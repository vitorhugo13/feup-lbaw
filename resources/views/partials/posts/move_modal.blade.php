<div class="modal fade" id="move-modal" tabindex="-1" role="dialog" aria-labelledby="mode-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mode-modal-title">Move</h5>
