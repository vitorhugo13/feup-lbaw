<?php function draw_post_preview($title, $author, $content, $upvotes, $downvotes, $comments) { ?>
    <div class="post-preview">
        ...
        <footer>
            <div class="votes">
                <div class="upvotes"><img src="../assets/hoof.svg" width="5" alt="uphoof" /><?=$upvotes?></div>
                <div class="downvotes"><img src="../assets/hoof.svg" width="5" alt="downhoof" /><?=$downvotes?></div>
            </div>
